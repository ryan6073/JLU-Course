...
#include <memory>
#include "../../QChatClient/loginview.h"
...
Q_CONSTINIT static const qt_meta_stringdata_LoginView_t qt_meta_stringdata_LoginView = {
    {
        ...
        QT_MOC_LITERAL(38, 15),  // "registerAccount"
        QT_MOC_LITERAL(54, 26),  // "on_pushButtonLogin_clicked"
        QT_MOC_LITERAL(81, 29)   // "on_pushButtonRegister_clicked"
    },
    "LoginView",
    "loginAccount",
    "",
...
void LoginView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->loginAccount((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        case 1: _t->registerAccount((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        ...
        {
            using _t = void (LoginView::*)(QString , QString );
...
// SIGNAL 0
void LoginView::loginAccount(QString _t1, QString _t2)
{
...
// SIGNAL 1
void LoginView::registerAccount(QString _t1, QString _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
