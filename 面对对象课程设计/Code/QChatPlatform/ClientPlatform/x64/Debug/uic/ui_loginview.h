...
public:
    ...
    void setupUi(QWidget *LoginView)
    {
        ...
        lineEditIdentification = new QLineEdit(LoginView);
        lineEditIdentification->setObjectName("lineEditIdentification");
        lineEditIdentification->setFont(font2);
        lineEditIdentification->setEchoMode(QLineEdit::Password);

        horizontalLayout_4->addWidget(lineEditIdentification);
    ...
    void retranslateUi(QWidget *LoginView)
    {
        ...
        label_3->setText(QCoreApplication::translate("LoginView", "\350\272\253\344\273\275\350\257\201\345\217\267", nullptr));
